...
|------|-------------|------|---------|:--------:|
| <a name="input_enable_data_lookups"></a> [enable\_data\_lookups](#input\_enable\_data\_lookups) | Enable read-only lookups of existing categories and affinity policies in Prism Central. | `bool` | `false` | no |
